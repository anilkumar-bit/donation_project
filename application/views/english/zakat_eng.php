        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="heading_with_text">
                    ...
                    <p>Zakat Calculator provides you with calculating and paying your Zakat through the Ihsan platform</p>
               ...
               <li class="mr-3">
                ...
                <li class="">
                    <a class=" ctm_round_btn ctm-round-btn-with-border" data-toggle="tab" href="#tabs-2"
                        role="tab">Stock<img src="<?php echo config_item('asset'); ?>image/icon-shares-hovered.svg"
                            alt=""></a>
                </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="zakat_amount p-4">
                                    <h5>Investment Funds Zakat Calculator</h5>
                                    ...
                                    <form class="">
                                        <div class="zakat_flex_wrap_content d-flex justify-content-around">
											<div class="form-group mx-1">
                                                <input type="text" class="form-control" name="fund_name" id="fund_name"
                                                    placeholder="Arrow name">
                                            </div>
										
											<div class="form-group mx-1">
                                                <input type="number" class="form-control" name="number_of"
                                                    id="number_of" placeholder="the number">
                                            </div>
                                        ...
                                        <button type="button" name="add_to_zakat" id="add_to_zakat"
                                            class="ctm_radius_btn">add to zakat</button>

                                        <div class="gold_rate_txt d-flex justify-content-between align-items-center mt-3 p-2" id="investment_total">
											<input type="hidden" name="investment_total_hidden" id="investment_total_hidden"
                                            <strong>Total value of mutual funds</strong>
											 <p class="m-0 pl-1 investment-addon1">0</p><span class="d-flex">AED</span>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="zakat_amount p-4">
                                    <h5>stock zakat calculator</h5>

                                    <form class="">
                                        <div class="d-flex  justify-content-around">
                                         
                                            <div class="form-group mx-1">
                                                <input type="email" class="form-control" placeholder="Arrow name" name="fund_name2" id="fund_name2">
                                            </div>
											
											  <div class="form-group mx-1">
                                                <input type="email" class="form-control" placeholder="the number" name="number_of2" id="number_of2">
                                            </div>
											
                                            <div class="form-group mx-1">
                                                <div class="ctm_input_set">
                                                    <input type="text" class="form-control" name="SAR2" id="SAR2" placeholder="the value">
                                                    <span class="ctm_input_span" aria-hidden="true">AED</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="gold_rate_txt d-flex justify-content-between align-items-center mt-3 p-2">
											  <strong>Total equity value</strong>
                                            <p class="m-0 pl-1">0</p><span class="d-flex">AED</span>
                                        </div>
                ...
                <div class="card_summary_section">
                    ...
                    <div class="">
                        <div class="amount_text d-flex justify-content-center align-items-center m-4">
                            ...
                            <strong class="ml-2">
                                <span>AED<p class="investment-addon1 m-0"></p></span>
                            </strong>
                        </div>

                        <div class="amount_input mx-4 mb-2">
                            <div class="ctm_input_set">
                                <input type="text" disabled class="form-control" placeholder="extra amount"
                        ...
                        <div class="text-center">
                            <a href="" class="ctm_radius_btn">Continue to pay</a>
                        </div>
