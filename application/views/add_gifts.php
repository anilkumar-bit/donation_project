				...
				<div class="row">
					<div class="col-md-8 col-lg-8  col-xl-9">
						<div class="account_section_inner_part p-5">
							...
							<form class="pt-4 row justify-content-end" action="<?php echo base_url(); ?>Admin/add_gifts_post" method="POST" enctype="multipart/form-data">
								
								  <div class="form-group col-md-9">
									<label class="mb-0">لقب</label>
									<input type="text" name="gift_title" id="title" class="form-control" required>
								  </div>
					...
					<div class="col-md-4 col-lg-4  col-xl-3">
						...
						<div class="account_section_inner_part mt-3">
							<ul class="account-navigation">
								...
								<li class="active_li"> <a href="<?php echo base_url() ?>admin/add_gifts">أضف الهدايا<span><i class="fa fa-address-card" aria-hidden="true"></i></span></a> </li>
