				...
				<div class="col-12">
					<div class="content">
						<div aria-label="breadcrumb" >
						  ...
						  <li class="breadcrumb-item active" aria-current="page">هدية رحمة</li>
...
<section class="post-card-section">
	<div class="container">
        ...
        <!---   test data   ---->
      <?php   
        foreach($relief_data as $relief_datas){
			// echo "<pre>";
			// print_r($relief_datas);
			// echo "</pre>";
		?>
		...
		<div class="col-md-6 col-lg-4">
				<div class="post-card mt-4">
					<div class="post-card-header d-flex justify-content-between align-items-center mb-3">
						...
						<h5><?php echo $relief_datas['title'];?></h5>
					</div>
					<div class="post-card-details">
						<a href="" class="d-block">
							<img src="<?php if($relief_datas['image']){ echo $relief_datas['image']; } ?>" alt="image" class="w-100">
							...
							<div class="row post-card-details-inner mt-4">
							    <div class="col">
									...
									<label class="d-flex justify-content-end align-items-center m-0"> <small class="mr-2 text-nowrap">AED</small><?php if($relief_datas['target_amount']){ echo $relief_datas['target_amount']; }  ?> </label>
								</div>
							...
							<form action="<?php echo base_url(); ?>Home/donationOperSingleView?id=<?php if($relief_datas['id']){ echo $relief_datas['id']; } ?>" id="rescue_form" method="GET" enctype="multipart/form-data">
								<div class="d-flex mt-3 justify-content-between">
							<!--<button type="submit" class="btn ctm_round_btn px-3" >
										<i class="fa fa-cart-plus" aria-hidden="true"></i>
									</button>  -->
									<button class="btn ctm_round_btn px-3  mx-2 " type="submit" name="submit" id="rescue_btn" onclick="navigateToDonation(this, '/projects/0/11728')">
										تبرع الآن
									</button>
									<div class="ctm-input-set">
										<input  type="text"  name="amt"class="form-control" id="amt" placeholder="مبلغ التبرع" >
										<input  type="hidden" name="id" value="<?php echo $relief_datas['id'] ?>" class="form-control" placeholder="" >
							...
							<a href="<?php echo base_url(); ?>Home/donationOperSingleView?id=<?php if($relief_datas['id']){ echo $relief_datas['id']; } ?>" class="text-dark">تفاصيل الحالة</a> 
							</div>
					</div>
				</div>
			</div>
